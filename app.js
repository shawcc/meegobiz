...
"features": [
{ "id": "feat_gantt_draft_sync", "name": "计划表草稿数据同步", "owner": "Core Team", "reqId": "1" },
{ "id": "feat_light_app_formula", "name": "轻应用页面变量公式计算", "owner": "Platform", "reqId": "2" },
{ "id": "feat_gantt_load_perf", "name": "计划表加载性能优化", "owner": "Core Team", "reqId": "3" },
{ "id": "feat_program_swimlane", "name": "项目集泳道图", "owner": "Core Team", "reqId": "4" },
{ "id": "feat_workitem_flow", "name": "工作项关联流程展示", "owner": "Core Team", "reqId": "5" },
{ "id": "feat_gantt_ref_col", "name": "计划表特化参考事项列", "owner": "Core Team", "reqId": "6" },
{ "id": "feat_sys_program", "name": "产品系统项目集", "owner": "Core Team", "reqId": "7" },
{ "id": "feat_wbs_custom_col", "name": "WBS子工作项自定义列", "owner": "Core Team", "reqId": "8" },
{ "id": "feat_ai_search", "name": "AI综搜优化", "owner": "AI Team", "reqId": "9" },
{ "id": "feat_gantt_col_mgmt", "name": "计划表列管理增强", "owner": "Core Team", "reqId": "10" },
{ "id": "feat_wbs_data_consist", "name": "WBS草稿数据一致性", "owner": "Core Team", "reqId": "11" },
{ "id": "feat_mobile_file_sec", "name": "移动端文件管控", "owner": "Sec Team", "reqId": "12" },
{ "id": "feat_ai_bill_3rd", "name": "AI计费支持三方应用", "owner": "Platform", "reqId": "13" },
{ "id": "feat_nav_arch", "name": "导航信息架构升级", "owner": "Platform", "reqId": "14" },
{ "id": "feat_template_logic", "name": "多产品模板逻辑改造", "owner": "Platform", "reqId": "15" },
{ "id": "feat_teams_integ", "name": "Teams集成", "owner": "Collaboration", "reqId": "16" },
{ "id": "feat_wbs_cross_dep", "name": "WBS跨计划表依赖", "owner": "Core Team", "reqId": "17" },
{ "id": "feat_config_as_code", "name": "配置代码化", "owner": "Platform", "reqId": "27" },
{ "id": "feat_ltc_master_data", "name": "LTC产品主数据", "owner": "LTC Team", "reqId": "28" },
{ "id": "feat_ltc_customer", "name": "LTC客户数据", "owner": "LTC Team", "reqId": "29" },
{ "id": "feat_perm_query", "name": "权限查询", "owner": "Identity", "reqId": "31" },
{ "id": "feat_ai_comment", "name": "评论区@AI", "owner": "AI Team", "reqId": "32" },
{ "id": "feat_workbench_upgrade", "name": "工作台3.0升级", "owner": "Platform", "reqId": "33" },
{ "id": "feat_light_app_drag", "name": "轻应用跨组件拖拽", "owner": "Platform", "reqId": "34" },
{ "id": "feat_light_app_lib", "name": "轻应用官方组件库", "owner": "Platform", "reqId": "35" },
{ "id": "feat_light_app_tabs", "name": "轻应用二级页签", "owner": "Platform", "reqId": "36" },
{ "id": "feat_light_app_nonadmin", "name": "非管理员配置轻应用", "owner": "Platform", "reqId": "37" },
{ "id": "feat_light_app_layout", "name": "轻应用布局优化", "owner": "Platform", "reqId": "38" },
{ "id": "feat_light_app_db", "name": "轻应用数据库组件", "owner": "Platform", "reqId": "39" },
{ "id": "feat_light_app_ai", "name": "轻应用组件AI能力", "owner": "AI Team", "reqId": "40" },
{ "id": "feat_ai_assistant", "name": "AI Assistant", "owner": "AI Team", "reqId": "41" },
{ "id": "feat_ai_analysis", "name": "AI分析组件", "owner": "AI Team", "reqId": "42" }
],
"capabilities": [
